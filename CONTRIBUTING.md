...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/ai_gen.git`).
...
Go to the [pull request page of AiGen][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/ai_gen/issues/new
[GitHub issues]: https://github.com/signmotion/ai_gen/issues/new
[PRs]: https://github.com/signmotion/ai_gen/pulls
